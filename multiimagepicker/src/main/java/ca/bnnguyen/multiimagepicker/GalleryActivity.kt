...
import ca.bnnguyen.multiimagepicker.databinding.ActivityGalleryBinding
    ...
    private fun initRecyclerView() {
        ...
        imagesAdapter = object: ImagesAdapter(this, maxSelectionLimit){
            ...
            override fun showMessageForMaxSelection() {
                Toast.makeText(this@GalleryActivity,getString(R.string.select_max_photo_error).format(maxSelectionLimit),
